const CardsMeals = (props) => {
    return (                 
    <div className='flex flex-col justify-between bg-white shadow-xl rounded-xl h-[260px] w-full md:w-3/4 mx-auto p-2 hover:scale-105 duration-500 cursor-pointer'>
