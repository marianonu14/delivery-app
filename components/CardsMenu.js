const CardsMenu = (props) => {
    return (                 
    <div className='flex flex-col justify-evenly bg-white shadow-xl rounded-xl h-[260px] md:w-full w-3/4 p-2 hover:scale-105 duration-500 cursor-pointer mx-auto'>
